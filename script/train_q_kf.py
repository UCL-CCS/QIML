...
num_bins = 32768
QG_prior_np = np.load("../postprocessing/Q-Prior_kf_pdf_15_2.npy")
#QG_prior_np = np.load("../postprocessing/Q-Prior.npy")
...
torch.save(model, '../mainmodel/final_QIML_model_kf_with_QG&id.pt')
print('Training complete. final_model_final_4_kf_with_QG&id saved.')
